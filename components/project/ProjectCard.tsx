...
const projectCard = (props: { project: Project; showDots?: boolean }) => {
  ...
  return (
    ...
    >
      <div
        className={`relative bg-gray-900 bg-opacity-40 transition-colors group-hover:bg-opacity-50 group-hover:bg-gray-800 rounded-2xl px-7 py-6 z-[1] backdrop-blur-md`}
      >
